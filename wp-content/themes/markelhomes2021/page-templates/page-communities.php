      ...
      <article class="community-box" id="<?php echo $post->post_name ?>">
        ...
        <div class="community-details">
          ...
          <p class="community-info">
            <?php echo get_field('square_footage') ?><br />
            <?php /* Priced from $<?php echo get_field('pricing'); */ ?>
          </p>
          <div class="community-link">
            <a href="<?php the_permalink(); ?>" title="<?php the_title() ?>" class="btn outline-btn gold-txt community-btn">visit community</a>
          </div>
